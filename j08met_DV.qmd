# Méthodologie de l'étude de l'occupation de l'espace
...
Tous les individus/années suivis par radiopistage ne seront pas utilisés pour les analyses sur le domaine vital. Pour sélectionner les individus nous avons commencé par modéliser des MCPs pour chaque individu. Ces MCPs ont été construit selon le protocole suivant :

- 10 localisations d'un individu sont prises au hasard et on construit le MCP avec ces 10 localisations.
- Pour le même individu on retire au hasard 10 localisations, et ce 50 fois, en construisant à chaque fois le MCP correspondant.
